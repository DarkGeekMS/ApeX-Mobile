...
/**
 * This class hold community information
 *
 * @author omar
 */
public class Community extends AppCompatActivity {
                ...
                new VolleyCallback() {
                  ...
                  public void onSuccessResponse(String result) {
                    try {
                      ...
                      if (value == "true") {
                        Toast.makeText(Community.this, "ayyy handel success", Toast.LENGTH_SHORT)
                            .show();
                      } else
                        Toast.makeText(Community.this, "ooooh noooo", Toast.LENGTH_SHORT).show();
  ...
  // here we assumed that the response will be either "subscribed" or "unsubscribed" with key
  // "state"
  public void getsubState(String id) {}

  /** This function handle send and get response from server using volley android */
  public void getsubResponse(
      int method,
      String url,
          ...
          public void onSuccessResponse(String response) {
            try {
              ...
              if (response != null) {
                ...
                if (notifications == "on") notifis.setChecked(true);
  ...
  /**
   * This function handle send subscribe request to apex comm
   *
   * @param commid :community id to be subscribed in
   * @param method :method of sent as GET,POST,DELETE,PATCH
   */
  public void subtocomm(
      String commid, int method, JSONObject jsonValue, final VolleyCallback callback) {
              ...
              public void onResponse(String response) {
                try {
                  ...
                  if (response != null) {
                    ...
                    Toast.makeText(
                            Community.this, "something went wrong.. try again", Toast.LENGTH_SHORT)
                        .show();
                  }
                } catch (JSONException e) {
                  e.printStackTrace();
