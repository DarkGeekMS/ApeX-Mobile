...
public class EditComment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getResponse(Request.Method.PATCH,Routes.edit,null, new  VolleyCallback(){
                    @Override
                    public void onSuccessResponse(String result) {
                        try {
                            ...
                            else  Toast.makeText(getApplicationContext(),"Error,comment isn`t edited",Toast.LENGTH_SHORT).show();

                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                },token,comment.getId(),body.getText().toString());
            }
        });
    ...
    { if(body.getText().toString().equals( beforeEdit)){finish(); }
    ...
    public void getResponse(int method, String url, JSONObject jsonValue, final VolleyCallback callback, final  String token, final String id, final String content) {
                ...
                new StringRequest(
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                int x=0;
                                Toast.makeText(
                                        EditComment.this.getApplicationContext(), "Server Error", Toast.LENGTH_SHORT)
                                        .show();
                                error.getMessage();
                            }
                        }) {
