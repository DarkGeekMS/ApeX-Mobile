 ...
 */
public class VolleySingletonForImage {
    private static VolleySingletonForImage mInstance;
     ...
     */
    private VolleySingletonForImage(Context context) {
        mCtx = context;
     ...
     */
    public static synchronized VolleySingletonForImage getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new VolleySingletonForImage(context);
        }
        return mInstance;
    }
