...
/** This activity class used to add comments to post */
public class AddCommentActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    /** Listener which activate when user click on button */
        ...
        new View.OnClickListener() {
          ...
          public void onClick(View v) {
            if (TextUtils.isEmpty(comment.getText()))
              Toast.makeText(getApplicationContext(), "please enter a message", Toast.LENGTH_SHORT)
                  .show();
            else {
                      ...
                      public void onSuccessResponse(String result) {
                        try {
                          ...
                          if (value != null) {
                            ...
                            Date currentTime = Calendar.getInstance().getTime();
                            String currendate =
                                "20" + Integer.toString(currentTime.getYear() - 100);
                            if (currentTime.getMonth() > 9) {
                              currendate += "-" + Integer.toString(currentTime.getMonth());
                            } else {
                              currendate +=
                                  "-" + "0" + Integer.toString(currentTime.getMonth() + 1);
                            }
                            currendate += "-" + Integer.toString(currentTime.getDate()) + " ";
                            currendate += Integer.toString(currentTime.getHours());
                            currendate += ":" + Integer.toString(currentTime.getMinutes());
  ...
  /**
   * This function handle cancel comment to ensure that user want to discard data
   *
   * @param v :view extend from class view
   */
