...
public class ExploreUserProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.explore_collapsingToolbarLayout);
        ...
        final TextView karmaCounterAndFollowers=(TextView) findViewById(R.id.explore_profile_creation_info);
    ...
    public void getResponse(
            ...
            final VolleyCallback callback,final  String name) {
